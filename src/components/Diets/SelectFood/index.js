...
const SelectFood = ({
  ...
  const validationSchema = Yup.object().shape({
    ...
    Sugar: Yup.number().typeError("Invalid number"),
    Fiber: Yup.number().typeError("Invalid number"),
    Sodium: Yup.number().typeError("Invalid number"),
    SR: Yup.number().typeError("Invalid number"),
    SatFat: Yup.number().typeError("Invalid number"),
    Protein: Yup.number().typeError("Invalid number"),
    Carbs: Yup.number().typeError("Invalid number"),
    Calories: Yup.number().typeError("Invalid number"),
    fat: Yup.number().typeError("Invalid number"),
